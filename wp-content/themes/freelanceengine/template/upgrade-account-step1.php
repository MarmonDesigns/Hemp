...
<div class="step-wrapper step-plan" id="step-plan">
    ...
    <div class="step-content-wrapper content">
        ...
        <?php foreach ($packs as $key => $package) { 
            ...
            $sku = $package->sku;
            $text = sprintf(__("You will have %d credits if using this plan.", ET_DOMAIN) , $number_of_post);  
        ?>
        	<li data-sku="<?php echo $package->sku ?>" data-id="<?php echo $package->ID ?>" data-price="<?php echo $package->et_price; ?>" data-package-type = "bid_plan" >
            	<span class="price">
