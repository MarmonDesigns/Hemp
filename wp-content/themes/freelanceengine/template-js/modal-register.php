<div class="modal fade" id="modal_register">
	<input type="hidden" value="<?php _e("Sell", ET_DOMAIN); ?>" class="work-text" name="worktext" />
	<input type="hidden" value="<?php _e("Buy", ET_DOMAIN); ?>" class="hire-text" name="hiretext" />
