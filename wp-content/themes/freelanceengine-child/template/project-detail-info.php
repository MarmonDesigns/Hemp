        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="info-project-item-right">
                ...
                <span class="link-clone">
                    <a href="<?php echo et_get_page_link( array('page_type' => 'submit-project', 'post_title' => __("Submit request", ET_DOMAIN )) ); ?>" title="">
                        <i class="fa fa-plus-circle"></i><?php _e('Create a Request like this',ET_DOMAIN);?>
                    </a>
                </span>
                <?php }  ?>
                <ul class="list-share-social addthis_toolbox addthis_default_style" >
                    ...
                    <li><a href="https://plus.google.com/share?url=<?php the_permalink();?>" title="<?php the_title();?>" target="_blank"  class=""><i class="fa fa-google-plus"></i></a></li> <!--addthis_button_google_plusone_share !-->
                </ul>
            </div>
        </div>
    </div>
