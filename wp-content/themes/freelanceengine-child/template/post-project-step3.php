...
<div class="step-wrapper step-post" id="step-post">
	<a href="#" class="step-heading active">
        ...
        <span class="text-heading-step"><?php _e("Enter your request details", ET_DOMAIN); ?></span>
            	...
            	<div class="row">
                	<div class="col-md-4">
                		<label for="post_title" class="control-label title-plan">
                            <?php _e("Request Title", ET_DOMAIN); ?>
                            <br/>
                            <span><?php _e("Enter a short title for your request", ET_DOMAIN); ?></span>
                        </label>
                    </div>
                    <div class="col-md-8 col-sm-12">
                        <input type="text" class="input-item form-control text-field" id="post_title" placeholder="<?php _e("Request Title", ET_DOMAIN); ?>" name="post_title">
                    </div>
                </div>
            </div>
            <!--// project title -->
            	...
            	<div class="row">
                	<div class="col-md-4">
                    	<label for="et_budget" class="control-label title-plan">
                            <?php printf(__("Budget ($)", ET_DOMAIN), fre_currency_sign(false) ); ?>
                        </label>
                    </div>
                    <div class="col-md-8 col-sm-12">
            	...
            	<div class="row">
                    <div class="col-md-4">
                        <label for="post_content" class="control-label title-plan">
                            ...
                            <br />
                            <span><?php _e("Describe your request in a few paragraphs", ET_DOMAIN); ?></span>
                        </label>
                    </div>
