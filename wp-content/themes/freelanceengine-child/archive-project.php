            ...
            <div class="row">
                <div class="col-md-3 col-xs-6 chosen-sort"> 
                    <select class="sort-order chosen-select" id="project_orderby" name="orderby" 
                        ...
                        <option value="date"><?php _e('Newest Requests first',ET_DOMAIN);?></option>
                        <option value="et_featured"><?php _e('Featured Requests first',ET_DOMAIN);?></option>
                        <option value="et_budget"><?php _e('Budget Requests first',ET_DOMAIN);?></option>
                    </select>                 
                </div>
                	...
                	<div class="tab-content-project">
                    	<div class="row title-tab-project">
                            <div class="col-md-5 col-sm-5 col-xs-7">
                                <span><?php _e("REQUEST TITLE", ET_DOMAIN); ?></span>
                            </div>
